			...
			<div className=" text-center py-5 container-fluid theme-bg-primary">
				<div className="single-col-max mx-auto">
					...
					<h1 className="hero-heading mb-5">
						<span className="brand mb-4 d-block"><span className="text-highlight pr-2"></span><span className="name">DevCourse</span>
	...
	<div className="sections-wrapper">
        ...
        <div className="section-blocks mb-5">
	        ...
	        <div id="section-faq" className="section-faq my-lg-5">
		        <div className="container">
			        <div className="container-inner p-5 theme-bg-light rounded">
				        <div className="row">
					        <div className="col-12 col-lg-3">
						        <h3 className="section-title text-start mb-4">FAQ</h3>
					        ...
					        <div className="col-12 col-lg-9">
						        <div className="faq-items pl-lg-3">
							        <div className="item">
										<h4 className="faq-q mb-2"><i className="far fa-question-circle me-2 text-primary"></i>What lorem ipsum dolor sit amet?</h4>
										<div className="faq-a">
									...
									<div className="item">
										<h4 className="faq-q mb-2"><i className="far fa-question-circle me-2 text-primary"></i>How to lorem ipsum dolor sit amet?</h4>
										<div className="faq-a">
									...
									<div className="item">
										<h4 className="faq-q mb-2"><i className="far fa-question-circle me-2 text-primary"></i>Does lorem ipsum dolor sit amet?</h4>
										<div className="faq-a">
									...
									<div className="item">
										<h4 className="faq-q mb-2"><i className="far fa-question-circle me-2 text-primary"></i>When do you lorem ipsum dolor sit amet?</h4>
										<div className="faq-a">
									...
									<div className="item">
										<h4 className="faq-q mb-2"><i className="far fa-question-circle me-2 text-primary"></i>Can I lorem ipsum dolor sit amet?</h4>
										<div className="faq-a">
